            ...
            {[1, 2, 3, 4, 5].map((star) => (
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill={star <= (hoveredStar ?? 0) ? '#fbbf24' : '#e5e7eb'}
                >
          ...
          <form onSubmit={handleNegativeFeedback} className="text-left">
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full rounded-2xl bg-gray-50 border border-gray-100 p-4 text-sm text-gray-800 placeholder-gray-400 focus:bg-white focus:border-blue-500 focus:outline-none transition-all duration-200 leading-relaxed resize-none"
                placeholder="Tell us how we can make things right directly with management..."
              />
            </div>
            <button 
              type="submit" 
              className="w-full rounded-2xl bg-gray-900 py-3.5 text-sm font-medium text-white shadow-sm hover:bg-gray-800 active:scale-95 transition-all duration-150"
            >
              Submit Feedback
            </button>
          </form>
